...
//    personService.deletePerson(3);
    ...
    System.out.println(
        "--------------Find By First Name   " + personService.findPersonByFirstName("vagish"));
    System.out.println(
        "--------------Find By Last Name   " + personService.findPersonByLastName("garg"));
    ...
    // Question 9
    System.out.println("-------------Query for count  " + personService.queryForCount("vagish"));

    // Quertion 10
    System.out.println("-------------Count by name   " + personService.countPerson("vagish"));
    System.out.println("-------------Distinct Age   " + personService.findDistinctAge(24));
    System.out.println("-------------Or   " + personService.findNameorAge("vagish", 35));
    System.out.println("-------------Abd   " + personService.findNameandAge("vagish", 24));
    ...
    System.out.println("-------------Like Demo  " + personService.likeDemo("vag"));
    System.out.println("-------------Not Demo" + personService.notDemo("Dixit"));
    ...
    // Named Native Query
    System.out.println(
        "--------------Named Native Query  " + personService.nativeNamedDemo("vagish"));
